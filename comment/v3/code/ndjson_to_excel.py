...
def main():
    ...
    NDJSON_FILE = Path(r"E:\NCS\fb-selenium\comment\v3\evidence_screenshots\uid_1434602990\uid_1434602990.ndjson")
    OUT_XLSX = Path(r"E:\NCS\fb-selenium\comment\v3\evidence_screenshots\uid_1434602990\uid_1434602990.xlsx")
